...
module.exports = {
  ...
  getPlayingCountEU() {
    return new Promise((resolve, reject) => {
      fetch('https://eu-match.helmetroyale.io:8100/count', { method: 'GET', headers: {Origin: 'https://helmetroyale.io'} })
        .then(res => res.json()).then(json => resolve(json.count))
    })
  },
  getPlayingCountUS() {
    return new Promise((resolve, reject) => {
      fetch('https://us-east-match.helmetroyale.io:8100/count', { method: 'GET', headers: {Origin: 'https://helmetroyale.io'} })
        .then(res => res.json()).then(json => resolve(json.count))
    })
  },
  getPlayingCountSA() {
    return new Promise((resolve, reject) => {
      fetch('https://sa-east-match.helmetroyale.io:8100/count', { method: 'GET', headers: {Origin: 'https://helmetroyale.io'} })
        .then(res => res.json()).then(json => resolve(json.count))
    })
  },
  getPlayingCountASIA() {
    return new Promise((resolve, reject) => {
      fetch('https://kor-match.helmetroyale.io:8100/count', { method: 'GET', headers: {Origin: 'https://helmetroyale.io'} })
        .then(res => res.json()).then(json => resolve(json.count))
    })
  }
}